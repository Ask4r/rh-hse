...
<template>
  <article class="content">
    ...
    <p class="plain-text">
      Большинство респондентов на первое по важности место поставили Бориса Ельцина, за ним идут Гайдар, Чубайс и Горбачев. Наименее популярными оказались Зюганов и Немцов. Интересно, что общее настроение ответов - негативное, и старшее (30-50) и младшее (16-22) поколения считают деятелей виновными в кризисе и развале страны. Среди категории 16-22 
    </p>
