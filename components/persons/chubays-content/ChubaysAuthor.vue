...
<template>
  <div class="content">
    ...
    <div class="author">
      <img src="/avatars/rabotaunakreml.png"
           alt="Ищенко Георгий"
           class="author__image">
      <p class="author__title">Ищенко Георгий</p>
      <p class="author__subtext">Rabotaetnakreml</p>
    </div>

    <div class="categories">
      <badge color="pink">Реформы</badge>
      <badge color="orange">Приватизация</badge>
      <badge color="indigo">Две Волги</badge>
    </div>
