...
<template>
    <div class="content">
        ...
        <div class="author">
            <img src="/avatars/dominus.png"
                 alt="Часвовских Никита"
                 class="author__image">
            <p class="author__title">Часовских Никита</p>
            <p class="author__subtext">Сделал в последний день</p>
        </div>

        <div class="categories">
            <badge color="gray">Перестройка</badge>
            <badge color="pink">Коррупция</badge>
            <badge color="blue">Парламент</badge>
        </div>
