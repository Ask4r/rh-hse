...
<template>
    <div class="content">
        ...
        <div class="author">
            <img src="/avatars/andre-yat.png"
                 alt="Носов Андрей"
                 class="author__image">
            <p class="author__title">Носов Андрей</p>
            <p class="author__subtext">Как так</p>
        </div>

        <div class="categories">
            <badge color="pink">Реформы</badge>
            <badge color="success">Экономика</badge>
            <badge color="gray-blue">Инфляция</badge>
        </div>
