...
<template>
  <div class="content">
    ...
    <div class="author">
      <img src="/avatars/terbium.png"
           alt="Булгаков Тимофей"
           class="author__image">
      <p class="author__title">Булгаков Тимофей</p>
      <p class="author__subtext">Работяга</p>
    </div>

    <div class="categories">
      <badge color="orange">Приватизация</badge>
      <badge color="success">Бизнесмен</badge>
    </div>
